...
import { getCourseCategoriesRequest } from '../../model/requests'

const ProfilePage = () => {
  const getUserInfo = useUserStore(useShallow((state) => state.getUserInfo))
  const { email, id, login, registrationDate } = useUserStore(
            ...
            <div className='profile-sidebar'>
              <div className='avatar-container'>
                <div
                  ...
                  dangerouslySetInnerHTML={{ __html: generateAvatar(login) }}
                />
              </div>
              ...
              <div className='profile-info'>
                <div className='profile-info-item'>
                  ...
                  <div className='profile-info-value'>{login}</div>
                </div>
                ...
                <div className='profile-info-item'>
                  ...
                  <div className='profile-info-value'>{registrationDate}</div>
                </div>
              </div>
                      ...
                      <div key={index} className='top-user'>
                        <div
                          ...
                          dangerouslySetInnerHTML={{
                            __html: generateAvatar(user.name, 40),
                          }}
                        />
